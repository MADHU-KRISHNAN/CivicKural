                    ...
                    (() => {
                      ...
                      return (
                        <span style={{
                          ...
                          borderRadius: '12px',
                          whiteSpace: 'nowrap',
                          background: slaTime.isOverdue ? 'rgba(239,68,68,0.1)' : 'rgba(34,197,94,0.1)',
                          color: slaTime.isOverdue ? '#dc2626' : '#16a34a',
                          border: `1px solid ${slaTime.isOverdue ? 'rgba(239,68,68,0.3)' : 'rgba(34,197,94,0.3)'}`
                        }}>
                          {slaTime.badge}
                        </span>
                      );
